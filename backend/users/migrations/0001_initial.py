# Generated by Django 3.2.3 on 2024-04-11 07:42
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(error_messages={'unique': 'Пользователь с таким username или с таким email уже существует'}, help_text='Не больше 150 символов.Только буквы, цифры и @/./+/-/_', max_length=32, unique=True, validators=[uttils.validators.validate_username], verbose_name='Пользователь')),
        ...
        migrations.AddConstraint(
            model_name='subscription',
            constraint=models.CheckConstraint(check=models.Q(('subscriber', django.db.models.expressions.F('author')), _negated=True), name='user_cannot_subscrib_himself'),
        ),
    ]
