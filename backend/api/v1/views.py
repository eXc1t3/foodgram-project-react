...
pdfmetrics.registerFont(TTFont('GilroyRegularFont', 'GilroyRegular.ttf'))
...
class RecipeViewSet(viewsets.ModelViewSet):
    ...
    def delete_favorite(self, request, pk):
        ...
        deleted_favorites, _ = Favorites.objects.filter(user=request.user,
    ...
    def delete_shopping_cart(self, request, pk):
        recipe = get_object_or_404(Recipe, id=pk)
        deleted_shopping_list, _ = (ShoppingCart.objects.filter(
    ...
    def download_shopping_cart_pdf(self, request):
        ...
        p.setFont('GilroyRegularFont', 14)
        y = 750
