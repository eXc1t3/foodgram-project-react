...
class SubscribeCreateSerializer(serializers.ModelSerializer):
    """Сериализатор для модели Subscribe Create"""
    class Meta:
        model = Subscribe
        fields = ('user', 'author')
        validators = [
...
class ShoppingCartSerializer(serializers.ModelSerializer):
    ...
    def to_representation(self, instance):
        return FavoritesAndShoppingCartResponseSerializer(instance).data
...
class FavoritesAndShoppingCartResponseSerializer(serializers.Serializer):
    """Сериализатор для вывода данных списка покупок и избранных"""
